    ...
    <div ref={wrapperRef} className="relative">
      <div
        ...
        className={`flex items-center border rounded-md bg-white px-3 gap-2 h-10 cursor-text transition-all
          ${open ? 'ring-2 ring-[#17325E] border-[#17325E]' : 'border-[#CDD1DA] hover:border-[#17325E]'}
            ...
            {filtered.length === 0 ? (
              ...
              >
                <div className="w-7 h-7 rounded-full bg-[#DEE8F7] flex items-center justify-center shrink-0">
                  <User className="h-3.5 w-3.5 text-[#17325E]" />
                </div>
                ...
                {eng.id === value && <CheckCircle2 className="h-4 w-4 text-[#17325E] shrink-0" />}
              </button>
            ))}
          </div>
    ...
    return (
      <div className="min-h-screen bg-[#F7F9FD] flex items-center justify-center font-['Montserrat']">
        <div className="text-center">
          <Loader2 size={40} className="animate-spin text-[#17325E] mx-auto mb-4" />
    ...
    return (
      <div className="min-h-screen bg-[#F7F9FD] p-6 font-['Montserrat']">
        <div className="max-w-6xl mx-auto">
          <button onClick={() => navigate('/assets')} className="flex items-center gap-2 text-[#17325E] hover:text-[#17325E] mb-4 font-semibold">
          ...
          <Card className="text-center py-16 border-[#CDD1DA] bg-white shadow-sm">
            <CardContent>
              ...
              <Button onClick={() => navigate('/assets')} variant="outline" className="border-[#17325E] text-[#17325E] font-semibold">
  ...
  return (
    <div className="min-h-screen bg-[#F7F9FD] p-6 font-['Montserrat']">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-6">
          <button onClick={() => navigate('/assets')} className="flex items-center gap-2 text-[#17325E] hover:text-[#17325E] mb-4 font-semibold transition-colors">
            <ArrowLeft size={20} /> Back to Assets
          </button>
          <div className="flex justify-between items-start gap-4">
            ...
            <div className="flex gap-2">
              <Badge className="text-sm bg-[#17325E] text-white font-semibold px-4 py-1">{asset.status}</Badge>
        ...
        {/* AI Insights */}
        {asset.ai_insights && (
          <Card className="mb-6 border-2 border-[#17325E] bg-gradient-to-br from-[#F7F9FD] to-white shadow-lg">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-[#17325E] font-bold">
                <Sparkles size={24} className="text-[#17325E]" /> AI-Powered Vehicle Insights
              </CardTitle>
            ...
            <CardContent>
              ...
              <div className="mt-4 flex items-center gap-2 text-sm text-[#17325E]">
          ...
          {[
            ...
            <Card key={label} className="border-[#CDD1DA] bg-white shadow-sm hover:shadow-md transition-shadow">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-bold flex items-center gap-2 text-[#17325E]">{icon} {label}</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <Card className="mb-6 border-[#CDD1DA] bg-white shadow-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-[#17325E] font-bold"><Car size={20} /> Vehicle Details</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={label}>
                  <p className="text-sm text-[#17325E] mb-1 font-bold">{label}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <Card className="border-[#CDD1DA] bg-white shadow-sm">
            <CardHeader><CardTitle className="flex items-center gap-2 text-[#17325E] font-bold"><Shield size={20} /> MOT Information</CardTitle></CardHeader>
            <CardContent className="space-y-4">
              <div><p className="text-sm text-[#17325E] mb-1 font-bold">Last MOT Date</p><p className="font-bold text-[#323843]">{formatDate(asset.last_mot_date)}</p></div>
              <div><p className="text-sm text-[#17325E] mb-1 font-bold">Next MOT Date</p><p className="font-bold text-[#323843]">{formatDate(asset.next_mot_date)}</p></div>
            </CardContent>
          </Card>
          <Card className="border-[#CDD1DA] bg-white shadow-sm">
            <CardHeader><CardTitle className="flex items-center gap-2 text-[#17325E] font-bold"><FileText size={20} /> Road Tax Information</CardTitle></CardHeader>
            <CardContent className="space-y-4">
              <div><p className="text-sm text-[#17325E] mb-1 font-bold">Last Road Tax</p><p className="font-bold text-[#323843]">{formatDate(asset.last_road_tax)}</p></div>
              <div><p className="text-sm text-[#17325E] mb-1 font-bold">Next Road Tax</p><p className="font-bold text-[#323843]">{formatDate(asset.next_road_tax)}</p></div>
            </CardContent>
          </Card>
          <Card className="border-[#CDD1DA] bg-white shadow-sm">
            <CardHeader><CardTitle className="flex items-center gap-2 text-[#17325E] font-bold"><Wrench size={20} /> Service Information</CardTitle></CardHeader>
            <CardContent className="space-y-4">
              <div><p className="text-sm text-[#17325E] mb-1 font-bold">Last Service Date</p><p className="font-bold text-[#323843]">{formatDate(asset.last_service_date)}</p></div>
              <div><p className="text-sm text-[#17325E] mb-1 font-bold">Next Service Date</p><p className="font-bold text-[#323843]">{formatDate(asset.next_service_date)}</p></div>
            </CardContent>
          </Card>
          <Card className="border-[#CDD1DA] bg-white shadow-sm">
            <CardHeader><CardTitle className="flex items-center gap-2 text-[#17325E] font-bold"><Users size={20} /> Current Assignment</CardTitle></CardHeader>
            <CardContent>
              <p className="text-sm text-[#17325E] mb-1 font-bold">Assigned Driver</p>
        ...
        <Card className="mb-6 border-[#CDD1DA] bg-white shadow-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              {!showNewForm && (
                <Button
                  ...
                  className="bg-[#17325E] hover:bg-[#0f1f3d] text-white flex items-center gap-2 shrink-0"
                >
          ...
          <CardContent>
            {/* ── NEW ALLOCATION FORM ── */}
            {showNewForm && (
              <div className="mb-6 border-2 border-[#17325E] rounded-xl p-5 bg-[#F0F5FC]">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-[#17325E] font-bold text-base flex items-center gap-2">
                    <Plus size={18} className="text-[#17325E]" /> New Allocation
                  </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="border-[#CDD1DA] focus:ring-[#17325E] focus:border-[#17325E] h-10"
                    />
                  </div>
                ...
                {/* Info banner */}
                <div className="mt-4 p-3 bg-[#DEE8F7] rounded-lg border border-[#17325E]/20">
                  <p className="text-xs text-[#17325E] font-medium flex items-start gap-2">
                    <span className="text-[#17325E] font-bold shrink-0">ℹ</span>
                ...
                <div className="flex gap-2 mt-4">
                  <Button
                    ...
                    className="bg-[#17325E] hover:bg-[#0f1f3d] text-white flex items-center gap-2"
                  >
                    {creatingAllocation
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div>
                            ...
                            <Input
                              ...
                              className="border-[#CDD1DA] focus:ring-[#17325E] h-10"
                            />
                          </div>
                          <div>
                            <label className="block text-sm font-semibold text-[#323843] mb-2">
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="flex flex-col gap-2 ml-4 shrink-0">
                          <Button
                            ...
                            variant="outline"
                            className="border-[#17325E] text-[#17325E] hover:bg-[#DEE8F7] flex items-center gap-2"
                          >
                            <Edit2 size={16} /> Edit
                          </Button>
                          <Button
        ...
        {/* Vehicle Image */}
        <Card className="mb-6 border-[#CDD1DA] bg-white shadow-sm">
          <CardHeader><CardTitle className="text-[#17325E] font-bold">Vehicle Image</CardTitle></CardHeader>
          <CardContent>
        ...
        <Card className="mb-6 border-[#CDD1DA] bg-white shadow-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-[#17325E] font-bold"><FileText size={20} /> Description</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        {/* Footer */}
        <Alert className="bg-[#F7F9FD] border-2 border-[#17325E]">
          <Zap size={16} className="text-[#17325E]" />
