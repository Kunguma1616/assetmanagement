    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="max-w-6xl mx-auto px-6 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Dashboard Card */}
          <Card className="hover:shadow-lg transition-shadow cursor-pointer bg-white" style={{ borderColor: '#17325E', borderWidth: 1 }} onClick={() => navigate('/fleet-dashboard')}>
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                <LayoutDashboard className="w-8 h-8" style={{ color: '#17325E' }} />
                <CardTitle>Fleet Dashboard</CardTitle>
              </div>
              <CardDescription>View overall fleet status and KPIs</CardDescription>
            </CardHeader>
            <CardContent>
              <Button className="w-full text-white" style={{ backgroundColor: '#17325E' }}>
                Open Dashboard
              </Button>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-12 w-12 rounded-md text-white" style={{ backgroundColor: '#17325E' }}>
                  ✓
                </div>
              </div>
              <div>
