              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={formData.vehicle_type} onValueChange={(value) => handleSelectChange('vehicle_type', value)}>
                    ...
                    <SelectContent>
                      <SelectItem value="Long wheel base high roof">Long wheel base high roof</SelectItem>
                      <SelectItem value="Long wheel base low roof">Long wheel base low roof</SelectItem>
                      <SelectItem value="Short wheel base">Short wheel base</SelectItem>
                      <SelectItem value="Cars">Cars</SelectItem>
                      <SelectItem value="Heavy Goods Vehicle">Heavy Goods Vehicle</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                ...
                <div>
                  ...
                  <Select value={formData.status} onValueChange={(value) => handleSelectChange('status', value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Spare Not Available">Spare Not Available</SelectItem>
                    </SelectContent>
                  </Select>
                </div>

                {/* ULEZ Compliant - FIXED VALUES */}
                <div>
                ...
                {/* Vehicle Ownership - FIXED VALUES */}
                <div>
                  ...
                  <Select value={formData.vehicle_ownership} onValueChange={(value) => handleSelectChange('vehicle_ownership', value)}>
                    ...
                    <SelectContent>
                      <SelectItem value="Aspect Owned">Aspect Owned</SelectItem>
                      <SelectItem value="Leased">Leased</SelectItem>
                      <SelectItem value="Via HSBC">Via HSBC</SelectItem>
                    </SelectContent>
                  </Select>
                </div>

                {/* Garage Repairs - FIXED VALUES */}
                <div>
                  ...
                  <Select value={formData.garage_repairs} onValueChange={(value) => handleSelectChange('garage_repairs', value)}>
                    ...
                    <SelectContent>
                      <SelectItem value="To be Collected by Fleet">To be Collected by Fleet</SelectItem>
