...
import {
  ...
  Users, Award, RefreshCw, Star, Medal, Target, Zap, Lock, MessageCircle,
} from 'lucide-react';
  ...
  return (
    <div className="wf-kpi" style={{
      ...
      <div style={{ width: 38, height: 38, borderRadius: 10, background: iconBg, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 14 }}>
        <Icon style={{ width: 18, height: 18, color: C.blueDark }} />
      </div>
      ...
      {/* Value */}
      <p style={{ fontSize: 34, fontWeight: 900, color: C.blueDark, margin: '0 0 2px', lineHeight: 1, fontFamily: FONT }}>
        {value}
      </p>
...
const Webfleet: React.FC = () => {
  ...
  const startWebfleetTour = () => {
    const steps = [
      {
        element: '#webfleet-kpis',
        popover: {
          title: 'Score Summary',
          description: 'These cards show the number of engineers, average score, top score, and who needs attention.',
          side: 'bottom' as const,
          align: 'start' as const,
        },
      },
      {
        element: '#webfleet-trade-breakdown',
        popover: {
          title: 'Trade Group Breakdown',
          description: 'This section shows how engineers are split across trade groups. Click a tile to focus on one group.',
          side: 'top' as const,
          align: 'start' as const,
        },
      },
      {
        element: '#webfleet-table-header',
        popover: {
          title: 'Engineer Rankings',
          description: 'This table ranks engineers by driving performance so you can quickly see your top and lowest performers.',
          side: 'bottom' as const,
          align: 'start' as const,
        },
      },
      {
        element: '#webfleet-table',
        popover: {
          title: 'Performance Details',
          description: 'Review rank, engineer name, van, trade group, performance band, and score in one place.',
          side: 'top' as const,
          align: 'start' as const,
        },
      },
      {
        popover: {
          title: 'You Are Ready',
          description: 'You can now review driver rankings, focus on weaker performers, and track performance by trade group.',
          side: 'over' as const,
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, fontFamily: FONT }}>
      ...
      <SectionHero
          ...
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 10 }}>
            ...
            <span
              style={{
                ...
                color: C.green,
                background: 'rgba(46,184,68,0.18)',
        ...
        title="Chumley Engineer Rankings"
        subtitle={
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
            <span>{displayStats ? `${displayStats.total_drivers} engineers · Webfleet driving scores` : 'Webfleet driving scores'}</span>
            {!showsAllTrades() && (
              <div
                title={`Viewing data for ${userTrade} trade only`}
                style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: 6,
        ...
        actions={<PageHeaderActions onStartGuide={startWebfleetTour} />}
      />
      ...
      <div style={{ padding: '0 40px 48px' }}>
        ...
        {displayStats && (
          <div id="webfleet-kpis" style={{ marginBottom: 28 }}>

            {/* Row 1 — 4 equal columns, full width */}
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                    <span style={{ fontSize: 38, fontWeight: 900, color: C.blueDark, lineHeight: 1, fontFamily: FONT }}>
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                {[
                  { label: 'Needs Improvement', val: displayStats.needs_improvement },
                  { label: 'Poor',              val: displayStats.poor              },
                ].map(item => (
                  <div key={item.label} style={{
                    textAlign: 'center', background: '#EEF2F8',
                    border: `1px solid ${C.blueDark}`,
                    borderRadius: 12, padding: '12px 18px', minWidth: 90,
                  }}>
                    <p style={{ fontSize: 28, fontWeight: 900, color: C.blueDark, margin: '0 0 3px', lineHeight: 1, fontFamily: FONT }}>
                      {item.val}
                    </p>
                    <p style={{ fontSize: 10, color: C.blueDark, margin: 0, fontWeight: 700, opacity: 0.85, fontFamily: FONT }}>
                      {item.label}
                    </p>
                  </div>
                ))}
        ...
        {engineers.length > 0 && (
          <div id="webfleet-trade-breakdown" style={{
            background: C.white,
            borderRadius: 16,
            border: `1px solid ${C.borderSubtle}`,
            padding: '24px 28px',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12 }}>
              {(() => {
                ...
                return sorted.map(([tradeGroup, count]) => {
                  ...
                  const isSelected = tradeGroup === selectedTradeGroup;
                  return (
                    <div
                      key={tradeGroup}
                      style={{
                        background: isSelected ? C.blueDark : '#EEF2F8',
                      ...
                      onMouseEnter={(e) => {
                        ...
                        (e.currentTarget as HTMLDivElement).style.boxShadow = `0 4px 16px rgba(23,50,94,0.25)`;
                      }}
                      onMouseLeave={(e) => {
                    ...
                    >
                      <p style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: isSelected ? 'rgba(255,255,255,0.7)' : C.gray, margin: '0 0 8px', fontFamily: FONT }}>
                        {tradeGroup}
                      </p>
                      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'center', gap: 6, marginBottom: 4 }}>
                        <span style={{ fontSize: 28, fontWeight: 900, color: isSelected ? '#FFFFFF' : C.blueDark, fontFamily: FONT }}>
                          {count}
                        </span>
                      </div>
                      <p style={{ fontSize: 11, color: isSelected ? 'rgba(255,255,255,0.7)' : C.blueDark, margin: 0, fontWeight: 600, fontFamily: FONT }}>
                        {percentage}% of fleet
                      </p>
                    </div>
                  );
        ...
        <div id="webfleet-table" style={{
          ...
          <div id="webfleet-table-header" style={{
            padding: '22px 32px',
