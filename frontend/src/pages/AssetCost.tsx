...
import {
  PoundSterlingIcon, Search, Download, Filter,
...
export default function AssetCost() {
  ...
  const startAssetCostTour = () => {
    const steps = [
      {
        element: "#asset-cost-stats",
        popover: {
          title: "Cost Summary",
          description: "These cards show your total spend, average cost, highest asset cost, and number of asset types.",
          side: "bottom" as const,
          align: "start" as const,
        },
      },
      {
        element: "#asset-cost-tabs",
        popover: {
          title: "View Options",
          description: "Switch between the overview and detailed asset cost view here.",
          side: "bottom" as const,
          align: "start" as const,
        },
      },
      {
        element: "#asset-cost-overview",
        popover: {
          title: "Cost Charts",
          description: "Use these charts to understand spend by asset type and your highest-cost assets.",
          side: "top" as const,
          align: "start" as const,
        },
      },
      {
        element: "#asset-cost-search",
        popover: {
          title: "Search Assets",
          description: "Search here to find a specific asset in the cost list quickly.",
          side: "bottom" as const,
          align: "start" as const,
        },
      },
      {
        popover: {
          title: "You Are Ready",
          description: "You can now review asset costs, compare categories, and find expensive assets quickly.",
          side: "over" as const,
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: FONT }}>
      ...
      <SectionHero
        ...
        title="Chumley Cost Tracking"
        subtitle={assets.length > 0 ? `${assets.length} assets tracked` : "Asset cost overview"}
        actions={<PageHeaderActions onStartGuide={startAssetCostTour} />}
      />

      {/* ── STAT CARDS (overlapping header) ────────────────────────────────── */}
      <div id="asset-cost-stats" style={{ padding: "0 36px", marginTop: -52, position: "relative", zIndex: 10 }}>
      ...
      <div style={{ padding: "24px 36px 40px" }}>
        ...
        {/* Tabs */}
        <div id="asset-cost-tabs" style={{ display: "flex", gap: 4, marginBottom: 24, background: C.white, borderRadius: 12, padding: 4, width: "fit-content", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
        ...
        {activeTab === "overview" && (
          <>
            <div id="asset-cost-overview" style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 20, marginBottom: 20 }}>
        ...
        {activeTab === "details" && (
          <>
            {/* Search / filter bar */}
            <div id="asset-cost-search" style={{ display: "flex", gap: 12, marginBottom: 20 }}>
