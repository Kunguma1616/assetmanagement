...
const colors = {
  primary: { default: '#17325E', light: '#7099DB', darker: '#17325E', subtle: '#F7F9FD' },
  brand: { yellow: '#F1FF24' },
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        {loading && (
          <div className="text-center py-12">
            <Loader size={48} className="animate-spin mx-auto mb-4" style={{ color: '#17325E' }} />
        ...
        {searched && !loading && vehicle && serviceCost && (
          <>
            ...
            <Card style={{ backgroundColor: 'white', borderColor: 'rgba(39, 84, 157, 0.2)', borderWidth: '1px', marginBottom: '24px' }}>
              <CardHeader>
                <CardTitle style={{ color: '#17325E' }}>Vehicle Information</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-3xl font-bold" style={{ color: '#17325E' }}>
                        £{serviceCost.total_cost.toLocaleString('en-GB', { maximumFractionDigits: 2 })}
                      </p>
                    </div>
                    <DollarSign size={40} style={{ color: '#17325E', opacity: 0.2 }} />
                  </div>
                </CardContent>
              </Card>
            ...
            <Card style={{ backgroundColor: 'white', borderColor: 'rgba(39, 84, 157, 0.2)', borderWidth: '1px' }}>
              <CardHeader>
                <CardTitle style={{ color: '#17325E' }}>Service Cost Breakdown (excluding Maintenance)</CardTitle>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-3">
                    {Object.entries(serviceCost.cost_by_type).map(([type, amount]) => (
                      <div key={type} className="flex items-center justify-between p-3 rounded-lg" style={{ backgroundColor: '#F7F9FD' }}>
                        ...
                        <span style={{ color: '#17325E', fontWeight: '600', fontSize: '16px' }}>
