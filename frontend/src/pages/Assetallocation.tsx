...
import {
  ArrowRightLeft, Search, Calendar,
  Filter, X, Download,
...
function StatCard({ label, value, sub, accent, icon: Icon }: {
  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: 30, fontWeight: 900, color: C.blueDark, margin: "0 0 2px", fontFamily: FONT, lineHeight: 1.1 }}>{value}</p>
...
export default function AssetAllocation() {
  ...
  const startAssetAllocationTour = () => {
    const steps = [
      {
        element: "#asset-allocation-stats",
        popover: {
          title: "Allocation Summary",
          description: "These cards show total movements, recent activity, assets moved, and average moves per asset.",
          side: "bottom" as const,
          align: "start" as const,
        },
      },
      {
        element: "#asset-allocation-charts",
        popover: {
          title: "Allocation Charts",
          description: "Use these charts to understand the most moved assets, top recipients, and monthly movement trend.",
          side: "top" as const,
          align: "start" as const,
        },
      },
      {
        element: "#asset-allocation-filters",
        popover: {
          title: "Filters",
          description: "Filter allocation history by asset, recipient, date range, and search terms.",
          side: "bottom" as const,
          align: "start" as const,
        },
      },
      {
        element: "#asset-allocation-table",
        popover: {
          title: "Allocation History",
          description: "This table shows the full movement history for assets so you can track who had what and when.",
          side: "top" as const,
          align: "start" as const,
        },
      },
      {
        popover: {
          title: "You Are Ready",
          description: "You can now review allocation activity, filter movements, and understand asset reassignment trends.",
          side: "over" as const,
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.bg, fontFamily: FONT }}>
      ...
      <SectionHero
        ...
        title="Chumley Allocation History"
        subtitle={`${fmt(data.total)} total movements recorded`}
        actions={<PageHeaderActions onStartGuide={startAssetAllocationTour} />}
      />

      {/* ── STAT CARDS ─────────────────────────────────────────────────────────── */}
      <div id="asset-allocation-stats" style={{ padding: "0 36px", marginTop: -52, position: "relative", zIndex: 10 }}>
      ...
      <div style={{ padding: "24px 36px 40px" }}>
        ...
        {/* Charts */}
        <div id="asset-allocation-charts" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 20, marginBottom: 20 }}>
        ...
        {/* ── TABLE ────────────────────────────────────────────────────────────── */}
        <div id="asset-allocation-table" style={{ background: C.white, borderRadius: 16, overflow: "hidden", boxShadow: "0 2px 12px rgba(39,84,157,0.07)", border: `1px solid ${C.borderSubtle}` }}>
          ...
          <div style={{ padding: "18px 24px", borderBottom: `1px solid ${C.borderSubtle}` }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
              ...
              <div id="asset-allocation-filters" style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
