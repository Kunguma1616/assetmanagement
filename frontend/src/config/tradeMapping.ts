...
export const RESTRICTED_USERS: Record<string, string[]> = {
  ...
  'peter.raynsford@aspect.co.uk':  ['Electrical'],
  // Trade Managers
  'sam.white@aspect.co.uk':        ['Drainage', 'Plumbing'],
  'george.widdowson@aspect.co.uk': ['Drainage', 'Plumbing'],
  'ryan.burns@aspect.co.uk':       ['Drainage', 'Plumbing'],
  'neil.lampton@aspect.co.uk':     ['Leak Detection'],
  'gavin.petty@aspect.co.uk':      ['Damp', 'Mould', 'Drying', 'Restoration'],
  'daniel.nicholls@aspect.co.uk':  ['Roofing', 'Multi', 'Decoration'],
  'oliver.meggs@aspect.co.uk':     ['Roofing', 'Multi', 'Decoration', 'Carpentry', 'General Builders', 'Building Fabric'],
  'darren.morley@aspect.co.uk':    ['Electrical'],
  'jack.brookman@aspect.co.uk':    ['Gas', 'HVAC'],
  'sam.manktelow@aspect.co.uk':    ['Electrical'],
  'robert.webster@aspect.co.uk':   ['Electrical'],
};
